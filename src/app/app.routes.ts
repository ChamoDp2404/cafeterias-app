...
import { ProductoFormComponent } from './pages/producto-form.component'; // ✅ Importación agregada
...
export const routes: Routes = [
  ...
  // ✅ NUEVA RUTA para agregar producto a cafetería
  { path: 'cafeterias/:id/productos/nuevo', component: ProductoFormComponent },
